...
**SpeedAI-Analyser** is a robust, real-time video analysis tool using **YOLOv8 + OpenCV** to detect, track, and precisely analyze objects (like vehicles or production items) in videos or live streams.
...
1.  **Clone the repo**:
    ```bash
    git clone [https://github.com/pandeymehak217-lab/SpeedAI-Analyser.git](https://github.com/pandeymehak217-lab/SpeedAI-Analyser.git)
    cd SpeedAI-Analyser
    ```
...
Here are example screenshots from the analysis. **Upload your screenshots to the `output/` folder and update the links below:**
